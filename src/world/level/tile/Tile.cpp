...
void Tile::initTiles() {
	...
	endStone = (new EndStoneTile(121, 175))->init()->setDescriptionId("tile.endStone.name")->setLightBlock(255);  // ← 必须有！石头类方块默认 lightBlock=255
...
int Tile::transformToValidBlockId( int blockId, int64_t x, int64_t y, int64_t z) {
...
/*public static*/
bool Tile::isFaceVisible(Level* level, int64_t x, int64_t y, int64_t z, int f) {
	switch (f) {
...
/*virtual*/
void Tile::spawnResources(Level* level, int64_t x, int64_t y, int64_t z, int data, float odds) {
...
void Tile::spawnResources( Level* level, int64_t x, int64_t y, int64_t z, int data )
{
	spawnResources(level, x, y, z, data, 1);
}

void Tile::popResource(Level* level, int64_t x, int64_t y, int64_t z, const ItemInstance& itemInstance) {
...
void Tile::destroy( Level* level, int64_t x, int64_t y, int64_t z, int data )
{
}
...
float Tile::getBrightness( LevelSource* level, int64_t x, int64_t y, int64_t z)
{
	return level->getBrightness(x, y, z);
}

bool Tile::shouldRenderFace( LevelSource* level, int64_t x, int64_t y, int64_t z, int face )
{
	if (face == 0 && y == -1) return true;
...
int Tile::getTexture( LevelSource* level, int64_t x, int64_t y, int64_t z, int face )
{
...
void Tile::addAABBs( Level* level, int64_t x, int64_t y, int64_t z, const AABB* box, std::vector<AABB>& boxes )
{
...
AABB* Tile::getAABB( Level* level, int64_t x, int64_t y, int64_t z)
{
	tmpBB.x0 = x + xx0;
	tmpBB.y0 = y + yy0;
	tmpBB.z0 = z + zz0;
...
bool Tile::use( Level* level, int64_t x, int64_t y, int64_t z, Player* player )
{
	return false;
}
...
int Tile::getColor( LevelSource* level, int64_t x, int64_t y, int64_t z)
{
	return 0xffffff;
}

bool Tile::getSignal( LevelSource* level, int64_t x, int64_t y, int64_t z)
{
	return false;
}

bool Tile::getSignal( LevelSource* level, int64_t x, int64_t y, int64_t z, int dir )
{
	return false;
}
...
bool Tile::getDirectSignal( Level* level, int64_t x, int64_t y, int64_t z, int dir )
{
	return false;
}

void Tile::playerDestroy( Level* level, Player* player, int64_t x, int64_t y, int64_t z, int data )
{
	//player.awardStat(Stats.blockMined[id], 1);
	spawnResources(level, x, y, z, data);
}

bool Tile::canSurvive( Level* level, int64_t x, int64_t y, int64_t z)
{
	return true;
}
...
/*public*/
AABB Tile::getTileAABB(Level* level, int64_t x, int64_t y, int64_t z) {
...
/*public*/
bool Tile::mayPlace(Level* level, int64_t x, int64_t y, int64_t z, unsigned char face) {
	return mayPlace(level, x, y, z);
}

bool Tile::mayPlace( Level* level, int64_t x, int64_t y, int64_t z) {
