...
void CropTile::tick( Level* level, int64_t x, int64_t y, int64_t z, Random* random ) {
...
void CropTile::growCropsToMax( Level* level, int64_t x, int64_t y, int64_t z) {
	level->setData(x, y, z, 7);
}

float CropTile::getGrowthSpeed( Level* level, int64_t x, int64_t y, int64_t z) {
	float speed = 1;
...
int CropTile::getTexture( LevelSource* level, int64_t x, int64_t y, int64_t z, int face ) {
...
void CropTile::spawnResources( Level* level, int64_t x, int64_t y, int64_t z, int data, float odds ) {
