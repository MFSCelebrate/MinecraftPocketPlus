...
int StairTile::getPlacedOnFaceDataValue(Level* level, int64_t x, int64_t y, int64_t z, int face, float clickX, float clickY, float clickZ, int itemValue) {
...
bool StairTile::setStepShape(LevelSource* level, int64_t x, int64_t y, int64_t z) {
...
/*
    ...
    * "inner corner."
    */
bool StairTile::setInnerPieceShape(LevelSource* level, int64_t x, int64_t y, int64_t z) {
    int data = level->getData(x, y, z);
    int dir = data & 0x3;
