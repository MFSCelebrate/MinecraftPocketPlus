...
void NetherReactorTileEntity::lightItUp( int64_t x, int64_t y, int64_t z) {
...
void NetherReactorTileEntity::clearDomeSpace( int64_t x, int64_t y, int64_t z) {
...
void NetherReactorTileEntity::buildDome( int64_t x, int64_t y, int64_t z) {
...
void NetherReactorTileEntity::buildHollowedVolume( int64_t x, int64_t y, int64_t z, int expandWidth, int height, const int wallTileId, const int clearTileId ) {
...
void NetherReactorTileEntity::buildFloorVolume( int64_t x, int64_t y, int64_t z, int expandWidth, int height, const int tileId ) {
	for(int curY = 0; curY < height; ++curY) {
		for(int curX = -expandWidth; curX <= expandWidth; ++curX) {
			for(int curZ = -expandWidth; curZ <= expandWidth; ++curZ) {
...
void NetherReactorTileEntity::buildCrockedRoofVolume( bool inverted, int64_t x, int64_t y, int64_t z, int expandWidth, int height, const int tileId ) {
...
void NetherReactorTileEntity::deterioateDome( int64_t x, int64_t y, int64_t z) {
...
void NetherReactorTileEntity::deterioateCrockedRoofVolume( bool inverted, int64_t x, int64_t y, int64_t z, int expandWidth, int height, int tileId ) {
	int fullHeight = height + expandWidth;
	for(int curX = -expandWidth; curX <= expandWidth; ++curX) {
		for(int curZ = -expandWidth; curZ <= expandWidth; ++curZ) {
			int offset = inverted ? ((-curX - curZ) / 2) : ((curX + curZ) / 2);
...
void NetherReactorTileEntity::deterioateHollowedVolume( int64_t x, int64_t y, int64_t z, int expandWidth, int height, int tileId ) {
	for(int curY = 0; curY < height; ++curY) {
		for(int curX = -expandWidth; curX <= expandWidth; ++curX) {
			for(int curZ = -expandWidth; curZ <= expandWidth; ++curZ) {
				if((curX == -expandWidth || curX == expandWidth)
