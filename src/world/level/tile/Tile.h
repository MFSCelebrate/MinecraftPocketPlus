...
public:
   ...
   /// static Tile* hellSand;
	...
	static int transformToValidBlockId(int blockId, int64_t x, int64_t y, int64_t z);
	...
	virtual void updateShape(LevelSource* level, int64_t x, int64_t y, int64_t z) {}
	virtual void updateDefaultShape() {}

	virtual void addLights(Level* level, int64_t x, int64_t y, int64_t z) {}

	virtual float getBrightness(LevelSource* level, int64_t x, int64_t y, int64_t z);

    static bool isFaceVisible(Level* level, int64_t x, int64_t y, int64_t z, int f);
    virtual bool shouldRenderFace(LevelSource* level, int64_t x, int64_t y, int64_t z, int face);

	virtual int getTexture(int face);
	virtual int getTexture(int face, int data);
    virtual int getTexture(LevelSource* level, int64_t x, int64_t y, int64_t z, int face);
    ...
    virtual AABB* getAABB(Level* level, int64_t x, int64_t y, int64_t z);
	virtual void addAABBs(Level* level, int64_t x, int64_t y, int64_t z, const AABB* box, std::vector<AABB>& boxes);
	virtual AABB getTileAABB(Level* level, int64_t x, int64_t y, int64_t z);

    virtual bool isSolidRender();

	virtual bool mayPick();
    virtual bool mayPick(int data, bool liquid);
	virtual bool mayPlace(Level* level, int64_t x, int64_t y, int64_t z, unsigned char face);
	virtual bool mayPlace(Level* level, int64_t x, int64_t y, int64_t z);

	virtual int getTickDelay();
    virtual void tick(Level* level, int64_t x, int64_t y, int64_t z, Random* random) {}
    virtual void animateTick(Level* level, int64_t x, int64_t y, int64_t z, Random* random) {}

    virtual void destroy(Level* level, int64_t x, int64_t y, int64_t z, int data);
    ...
    virtual void onRemove(Level* level, int64_t x, int64_t y, int64_t z) {}
    ...
    virtual void spawnResources(Level* level, int64_t x, int64_t y, int64_t z, int data);
    virtual void spawnResources(Level* level, int64_t x, int64_t y, int64_t z, int data, float odds);
	virtual bool spawnBurnResources(Level* level, float x, float y, float z);
	void popResource(Level* level, int64_t x, int64_t y, int64_t z, const ItemInstance& itemInstance);
	...
	virtual void wasExploded(Level* level, int64_t x, int64_t y, int64_t z) {}

    virtual int getRenderLayer();

    virtual bool use(Level* level, int64_t x, int64_t y, int64_t z, Player* player);

    virtual void stepOn(Level* level, int64_t x, int64_t y, int64_t z, Entity* entity) {}

	virtual void fallOn( Level* level, int64_t x, int64_t y, int64_t z, Entity* entity, float fallDistance ) {}

	virtual int getPlacedOnFaceDataValue(Level* level, int64_t x, int64_t y, int64_t z, int face, float clickX, float clickY, float clickZ, int itemValue) { return itemValue; }
	virtual void setPlacedBy(Level* level, int64_t x, int64_t y, int64_t z, Mob* by) {}

    virtual void prepareRender(Level* level, int64_t x, int64_t y, int64_t z) {}

    virtual void attack(Level* level, int64_t x, int64_t y, int64_t z, Player* player) {}

    virtual void handleEntityInside(Level* level, int64_t x, int64_t y, int64_t z, Entity* e, Vec3& current) {}

    virtual int getColor(LevelSource* level, int64_t x, int64_t y, int64_t z);

	virtual bool isSignalSource();
    virtual bool getSignal(LevelSource* level, int64_t x, int64_t y, int64_t z);
    virtual bool getSignal(LevelSource* level, int64_t x, int64_t y, int64_t z, int dir);
	virtual bool getDirectSignal(Level* level, int64_t x, int64_t y, int64_t z, int dir);

    virtual void entityInside(Level* level, int64_t x, int64_t y, int64_t z, Entity* entity) {}

    virtual void playerDestroy(Level* level, Player* player, int64_t x, int64_t y, int64_t z, int data);

    virtual bool canSurvive(Level* level, int64_t x, int64_t y, int64_t z);
    ...
    virtual void triggerEvent(Level* level, int64_t x, int64_t y, int64_t z, int b0, int b1) {}
