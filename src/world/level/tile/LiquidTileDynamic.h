...
public:
    ...
    /*protected*/
	int getHighest(Level* level, int64_t x, int64_t y, int64_t z, int current) {
...
private:
    void setStatic(Level* level, int64_t x, int64_t y, int64_t z) {
	...
	bool canSpreadTo(Level* level, int64_t x, int64_t y, int64_t z) {
    ...
    bool isWaterBlocking(Level* level, int64_t x, int64_t y, int64_t z) {
    ...
    bool* getSpread(Level* level, int64_t x, int64_t y, int64_t z) {
        for (int d = 0; d < 4; d++) {
            dist[d] = 1000;
            int xx = x;
            int yy = y;
    ...
    void trySpreadTo(Level* level, int64_t x, int64_t y, int64_t z, int neighbor) {
    ...
    int getSlopeDistance(Level* level, int64_t x, int64_t y, int64_t z, int pass, int from) {
        int lowest = 1000;
        for (int d = 0; d < 4; d++) {
