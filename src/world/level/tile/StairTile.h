...
public:
	...
	void setBaseShape(LevelSource* level, int64_t x, int64_t y, int64_t z) {
	...
	bool isLockAttached(LevelSource* level, int64_t x, int64_t y, int64_t z, int data) {
	...
	bool setStepShape(LevelSource* level, int64_t x, int64_t y, int64_t z);
	bool setInnerPieceShape(LevelSource* level, int64_t x, int64_t y, int64_t z);
...
//    }
    ...
    void addLights(Level* level, int64_t x, int64_t y, int64_t z) {
    ...
    void prepareRender(Level* level, int64_t x, int64_t y, int64_t z) {
