...
int TallGrass::getColor( LevelSource* level, int64_t x, int64_t y, int64_t z) {
...
void TallGrass::playerDestroy( Level* level, Player* player, int64_t x, int64_t y, int64_t z, int data ) {
