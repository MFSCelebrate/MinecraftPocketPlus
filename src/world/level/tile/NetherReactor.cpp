...
bool NetherReactor::use( Level* level, int64_t x, int64_t y, int64_t z, Player* player ) {
...
void NetherReactor::setPhase(Level* level, int64_t x, int64_t y, int64_t z, int phase) {
...
bool NetherReactor::canSpawnStartNetherReactor( Level* level, int64_t x, int64_t y, int64_t z, Player* player ) {
...
bool NetherReactor::allPlayersCloseToReactor( Level* level, int64_t x, int64_t y, int64_t z) {
