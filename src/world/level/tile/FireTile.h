...
public:
    ...
    bool canBurn(LevelSource* level, int64_t x, int64_t y, int64_t z) {
        return flameOdds[level->getTile(x, y, z)] > 0;
    }

    int getFlammability(Level* level, int64_t x, int64_t y, int64_t z, int odds) {
    ...
    void ignite(Level* level, int64_t x, int64_t y, int64_t z) {
		return; //@fire
...
private:
    ...
    void checkBurn(Level* level, int64_t x, int64_t y, int64_t z, int chance, Random* random) {
        return; //@fire
    ...
    bool isValidFireLocation(Level* level, int64_t x, int64_t y, int64_t z) {
		return false; //@fire
    ...
    int getFireOdds(Level* level, int64_t x, int64_t y, int64_t z) {
        return 0; //@fire
	...
	bool tryIgnite(Level* level, int64_t x, int64_t y, int64_t z) {
        return false; //@fire
