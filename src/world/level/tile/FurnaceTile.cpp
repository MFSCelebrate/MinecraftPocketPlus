...
void FurnaceTile::onPlace( Level* level, int64_t x, int64_t y, int64_t z)
{
	super::onPlace(level, x, y, z);
	recalcLockDir(level, x, y, z);
}

int FurnaceTile::getTexture( LevelSource* level, int64_t x, int64_t y, int64_t z, int face )
{
...
bool FurnaceTile::use( Level* level, int64_t x, int64_t y, int64_t z, Player* player )
{
...
/*static*/
void FurnaceTile::setLit( bool lit, Level* level, int64_t x, int64_t y, int64_t z)
{
...
void FurnaceTile::setPlacedBy( Level* level, int64_t x, int64_t y, int64_t z, Mob* by )
{
...
void FurnaceTile::onRemove( Level* level, int64_t x, int64_t y, int64_t z)
{
...
void FurnaceTile::recalcLockDir( Level* level, int64_t x, int64_t y, int64_t z)
{
	if (level->isClientSide) {
		return;
	}
