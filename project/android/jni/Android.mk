...
../../../src/world/item/NegativePickaxeItem.cpp \
...
../../../src/world/level/levelgen/TheEndLevelSource.cpp \
...
LOCAL_CFLAGS := -DANDROID -DPLATFORM_ANDROID -DPRE_ANDROID23 -Wno-narrowing $(LOCAL_CFLAGS) -DPROFILER -DUSE_VBO
LOCAL_C_INCLUDES := $(LOCAL_PATH)/../../../src $(LOCAL_PATH)/../../../src/contrib
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../../src/contrib/boost

LOCAL_CPPFLAGS := -std=c++14 -frtti -DPROFILER
LOCAL_CPPFLAGS += -frtti -DPROFILER

#LOCAL_CFLAGS := -DDEMO_MODE $(LOCAL_CFLAGS)
